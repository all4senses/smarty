...
${OBJECTDIR}/_ext/bff511d8/myGBoard_26.o: ../../myGBoard_26/myGBoard_26.ino 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/bff511d8/myGBoard_26.o ../../myGBoard_26/myGBoard_26.ino

${OBJECTDIR}/_ext/1f6c4868/myMEGA_29.o: ../../myMEGA_29/myMEGA_29.ino 
	${MKDIR} -p ${OBJECTDIR}/_ext/1f6c4868
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1f6c4868/myMEGA_29.o ../../myMEGA_29/myMEGA_29.ino

${OBJECTDIR}/_ext/8b0c1c9b/myUNO_28.o: ../../myUNO_28/myUNO_28.ino 
	${MKDIR} -p ${OBJECTDIR}/_ext/8b0c1c9b
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/8b0c1c9b/myUNO_28.o ../../myUNO_28/myUNO_28.ino
